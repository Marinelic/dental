        ...
        <div className='container mx-auto lg:px-50 px-10 flex flex-col-reverse lg:flex-row items-center justify-between gap-10'>
            <div className='max-w-xl text-center lg:text-left space-y-6'>
                <h1 className='text-xl sm:text-4xl lg:text-5xl font-bold text-sky-900 leading-tight'>
                    Brighten Zour Smile <br /> with Expert Dental Care
                </h1>
                ...
                <a id='book' className='inline-flex items-center bg-sky-600 text-white px-3 py-1 sm:px-6 sm:py-3 rounded-xl hover:bg-sky-700 transition text-base font-medium'>
            ...
            <div className='flex justify-center'>
                <img src={hero} alt="Dental" className='w-90 lg:w-[429px] rounded-4xl' />
            </div>
        </div>
   </section>
  );
